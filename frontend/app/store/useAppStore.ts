...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  fetchProfile: async () => {
    ...
    try {
      ...
      if (err.response) {
        console.error("[Zustand Store] Profile Fetch Server Error Data:", err.response.data);
      }
  ...
  fetchProducts: async () => {
    ...
    try {
      ...
      if (err.response) {
        console.error("[Zustand Store] Products Fetch Server Error Data:", err.response.data);
      }
  ...
  login: async (phone, password) => {
    ...
    try {
      ...
      if (err.response) {
        console.error("[Zustand Store] Login Server Error Data:", err.response.data);
      }
  ...
  register: async (fullName, phone, password, referredBy) => {
    ...
    try {
      ...
      if (err.response) {
        console.error("[Zustand Store] Register Server Error Data:", err.response.data);
      }
